...
function LanguagesListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    languagesSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'name'}
                  label={i18n(
                    'entities.languages.fields.name',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'active'}
                  label={i18n(
                    'entities.languages.fields.active',
                  )}
                />
              <TableColumnHeader />
            </tr>
