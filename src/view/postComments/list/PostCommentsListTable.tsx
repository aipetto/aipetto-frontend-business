...
function PostCommentsListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    postCommentsSelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.postComments.fields.postId',
                  )}
                />
              <TableColumnHeader />
            </tr>
...
export default PostCommentsListTable;
