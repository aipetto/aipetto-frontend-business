...
import selectors from 'src/modules/providers/providersSelectors';

function ProvidersViewItem(props) {
...
ProvidersViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
};

export default ProvidersViewItem;
