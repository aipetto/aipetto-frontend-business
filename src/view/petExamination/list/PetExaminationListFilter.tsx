...
const schema = yup.object().shape({
  ...
  examinationInternalCode: yupFilterSchemas.string(
...
function PetExaminationListFilter(props) {
...
export default PetExaminationListFilter;