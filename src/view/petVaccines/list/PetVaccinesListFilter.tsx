...
const schema = yup.object().shape({
  ...
  datetimeTakenRange: yupFilterSchemas.datetimeRange(
    i18n('entities.petVaccines.fields.datetimeTakenRange'),
  ),
  veterinarianID: yupFilterSchemas.relationToOne(
    i18n('entities.petVaccines.fields.veterinarianID'),
  ),
  placeTaken: yupFilterSchemas.relationToOne(
...
export default PetVaccinesListFilter;