...
function PetVaccinesListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    petVaccinesSelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.petVaccines.fields.name',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
...
export default PetVaccinesListTable;
