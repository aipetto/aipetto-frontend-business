...
import actions from 'src/modules/vaccineTypes/importer/vaccineTypesImporterActions';
...
function VaccineTypesImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.vaccineTypes.importer.hint'),
  );
...
export default VaccineTypesImportPage;
