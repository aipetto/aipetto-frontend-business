...
function VaccineTypesListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    vaccineTypesSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'name'}
                  label={i18n(
                    'entities.vaccineTypes.fields.name',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
...
export default VaccineTypesListTable;
