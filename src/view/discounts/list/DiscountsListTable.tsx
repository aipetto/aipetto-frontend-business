...
function DiscountsListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    discountsSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'codeName'}
                  label={i18n(
                    'entities.discounts.fields.codeName',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  label={i18n(
                    'entities.discounts.fields.discountPercentage',
                  )}
                  align="right"
                />
                <TableColumnHeader
                  ...
                  name={'expirationDate'}
                  label={i18n(
                    'entities.discounts.fields.expirationDate',
                  )}
                />
              <TableColumnHeader />
            </tr>
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">{row.expirationDate}</td>
                  <td
