...
function BusinessPlaceServiceAvailabilityViewToolbar(props) {
  const [
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/business-place-service-availability/${id}/edit`}>
          <button
...
export default BusinessPlaceServiceAvailabilityViewToolbar;
