...
function BusinessPlaceServiceAvailabilityViewItem(props) {
      ...
      return (
        <div key={record.id}>
          <Link
            ...
            to={`/business-place-service-availability/${record.id}`}
          >
            {record.name}
          </Link>
        </div>
...
BusinessPlaceServiceAvailabilityViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
};

export default BusinessPlaceServiceAvailabilityViewItem;
