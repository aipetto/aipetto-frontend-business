...
function BusinessPlaceServiceAvailabilityFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await BusinessPlaceServiceAvailabilityService.create(data);
...
export default BusinessPlaceServiceAvailabilityFormModal;
