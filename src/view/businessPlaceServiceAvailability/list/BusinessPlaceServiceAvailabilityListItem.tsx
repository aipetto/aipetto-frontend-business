...
function BusinessPlaceServiceAvailabilityListItem(props) {
...
BusinessPlaceServiceAvailabilityListItem.propTypes = {
  value: PropTypes.any,
};

export default BusinessPlaceServiceAvailabilityListItem;
