...
function BusinessServicesPricesListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    businessServicesPricesSelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.businessServicesPrices.fields.service',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'servicePrice'}
                  label={i18n(
                    'entities.businessServicesPrices.fields.servicePrice',
                  )}
                  align="right"
                />
              <TableColumnHeader />
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    <BusinessServicesTypesListItem value={row.service} />
                  </td>
                  ...
                  >
                    <Link
                      ...
                      to={`/business-services-prices/${row.id}`}
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/business-services-prices/${row.id}/edit`}
...
export default BusinessServicesPricesListTable;
