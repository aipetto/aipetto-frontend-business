...
function ProfessionalsServiceAvailabilityListItem(props) {
...
ProfessionalsServiceAvailabilityListItem.propTypes = {
  value: PropTypes.any,
};

export default ProfessionalsServiceAvailabilityListItem;
