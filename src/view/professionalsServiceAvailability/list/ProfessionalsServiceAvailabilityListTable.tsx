...
function ProfessionalsServiceAvailabilityListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    professionalsServiceAvailabilitySelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.professionalsServiceAvailability.fields.userId',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                ...
                <tr key={row.id}>
                  ...
                  >
                    <Link
                      ...
                      to={`/professionals-service-availability/${row.id}`}
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/professionals-service-availability/${row.id}/edit`}
...
export default ProfessionalsServiceAvailabilityListTable;
