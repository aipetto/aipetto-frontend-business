...
function ProfessionalsServiceAvailabilityFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ProfessionalsServiceAvailabilityService.create(data);
...
export default ProfessionalsServiceAvailabilityFormModal;
