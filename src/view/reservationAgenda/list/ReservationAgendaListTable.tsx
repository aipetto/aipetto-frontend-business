...
function ReservationAgendaListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    reservationAgendaSelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.reservationAgenda.fields.businessId',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.reservationAgenda.fields.timeSlot',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.reservationAgenda.fields.serviceType',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'name'}
                  label={i18n(
                    'entities.reservationAgenda.fields.name',
                  )}
                />
              <TableColumnHeader />
            </tr>
                ...
                <tr key={row.id}>
                  ...
                  >
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/reservation-agenda/${row.id}/edit`}
...
export default ReservationAgendaListTable;
