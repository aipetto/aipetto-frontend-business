            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'initials'}
                  label={i18n(
                    'entities.state.fields.initials',
                  )}
                />
              <TableColumnHeader />
            </tr>
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">{row.initials}</td>
                  <td
