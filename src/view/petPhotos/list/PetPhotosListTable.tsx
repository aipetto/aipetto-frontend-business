...
function PetPhotosListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    petPhotosSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'description'}
                  label={i18n(
                    'entities.petPhotos.fields.description',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.petPhotos.fields.petId',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
...
export default PetPhotosListTable;
