...
function BusinessPaymentCycleListItem(props) {
      ...
      return (
        <div key={record.id}>
          <Link
            ...
            to={`/business-payment-cycle/${record.id}`}
          >
            {record.id}
          </Link>
        </div>
...
BusinessPaymentCycleListItem.propTypes = {
  value: PropTypes.any,
};

export default BusinessPaymentCycleListItem;
