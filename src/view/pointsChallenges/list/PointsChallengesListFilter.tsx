...
const schema = yup.object().shape({
  ...
  pointsRange: yupFilterSchemas.integerRange(
    i18n('entities.pointsChallenges.fields.pointsRange'),
  ),
...
const previewRenders = {
  ...
  pointsRange: {
    label: i18n('entities.pointsChallenges.fields.pointsRange'),
...
function PointsChallengesListFilter(props) {
...
export default PointsChallengesListFilter;