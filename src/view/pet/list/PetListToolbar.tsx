...
import petSelectors from 'src/modules/pet/petSelectors';
import destroyActions from 'src/modules/pet/destroy/petDestroyActions';
import destroySelectors from 'src/modules/pet/destroy/petDestroySelectors';
...
function PetToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    petSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    petSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    petSelectors.selectPermissionToImport,
  );
