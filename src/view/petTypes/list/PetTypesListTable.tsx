...
function PetTypesListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    petTypesSelectors.selectPermissionToEdit,
  );
          ...
          <thead>
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  label={i18n(
                    'entities.petTypes.fields.language',
                  )}
                />
              <TableColumnHeader />
            </tr>
...
export default PetTypesListTable;
