...
const schema = yup.object().shape({
  diseaseCommonName: yupFilterSchemas.string(
    i18n('entities.petDiseases.fields.diseaseCommonName'),
  ),
  diseaseScientificNames: yupFilterSchemas.string(
    i18n('entities.petDiseases.fields.diseaseScientificNames'),
  ),
  isHumanContagious: yupFilterSchemas.boolean(
    i18n('entities.petDiseases.fields.isHumanContagious'),
  ),
  isPetContagious: yupFilterSchemas.boolean(
...
const emptyValues = {
  ...
  diseaseScientificNames: null,
  isHumanContagious: null,
  isPetContagious: null,
  language: null,
}
...
const previewRenders = {
  ...
  language: {
    ...
    render: filterRenders.enumerator('entities.petDiseases.enumerators.language',),
  },
}

function PetDiseasesListFilter(props) {
...
export default PetDiseasesListFilter;