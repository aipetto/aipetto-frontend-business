...
import PostCommentsListItem from 'src/view/postComments/list/PostCommentsListItem';
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'title'}
                  label={i18n(
                    'entities.posts.fields.title',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                    'entities.posts.fields.comments',
                  )}
                />
              <TableColumnHeader />
            </tr>
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    <PostCommentsListItem value={row.comments} />
                  </td>
                  <td
