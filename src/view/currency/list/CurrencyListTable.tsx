...
function CurrencyListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    currencySelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'symbol'}
                  label={i18n(
                    'entities.currency.fields.symbol',
                  )}
                />
                <TableColumnHeader
                  onSort={doChangeSort}
                  ...
                  name={'active'}
                  label={i18n(
                    'entities.currency.fields.active',
                  )}
                />
              <TableColumnHeader />
            </tr>
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">{row.symbol}</td>
