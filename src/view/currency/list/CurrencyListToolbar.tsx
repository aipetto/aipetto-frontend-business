...
function CurrencyToolbar(props) {
  const [
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="currency-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="currency-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="currency-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="currency-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
