                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row items-center content-center py-12 lg:pt-16 lg:pb-32">
                            ...
                            <div className="feature-1 md:w-1/2 text-center mb-4 lg:mb-0 relative">
                                <img src="images/mocks/aipettoMobileTablet.png" className="lazy mx-auto z-10 relative w-3/3 md:w-4/5 lg:w-3/3" alt="Mobile Device"/>
                        ...
                        <div className="  text-center flex flex-col md:flex-row">
                            ...
                            <div className="md:w-1/2 flex flex-col   my-4 lg:my-0 md:px-4">
                                <blockquote className="italic text-gray-700 text-sm md:text-md lg:text-lg lg:order-last order-first">
                                    “Sempre tive que usar uma app diferente para tudo. Uma para encontrar cruza para meu cachorro, uma para conseguir alguém que pudesse passear o cachorro do meu avô, outra para comprar comidas e acessórios por um bom preço, outra para encontrar pets que adotar, outra para ver quais pets meus amigos tem... com AIPETTO eu consigo fazer tudo e muito mais e em uma plataforma só, amei!“
                                </blockquote>
                            </div>
