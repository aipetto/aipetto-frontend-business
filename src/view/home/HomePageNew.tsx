                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="container py-20 mx-auto text-center sm:px-4">
                        <h2 className="text-4xl font-extrabold leading-10 tracking-tight text-white sm:text-5xl sm:leading-none md:text-6xl xl:text-7xl">
                            <span className="block ">{i18n('homeDownloadApp.tagline')}</span>
                        </h2>
                    </div>
                                ...
                                <div className="w-full md:w-1/2 md:px-3">
                                    <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                        <div className="relative flex items-center mt-10 max-w-md mx-auto overflow-hidden text-center">
                                            <img src="images/qr-aipetto-google-play-store.png" alt="Aipetto QR" className="lazy mx-auto z-10 relative w-2/3 md:w-3/5 lg:w-2/3"/>
                                        </div>
                                        <div className="mt-8 text-black-100">

                                            <a href="https://play.google.com/store/apps/details?id=com.aipetto" className="bg-yellow-500 hover:bg-yellow-600 rounded border border-yellow-600 hover:border-yellow-700 shadow font-semibold px-4 py-2 inline-block mx-2 cursor-pointer transition duration-500 ease-in-out">
