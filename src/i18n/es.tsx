const es = {
    ...
    survey: {
        ...
        checkboxChoices: {
            ...
            reserveServices: 'Reservar en línea el horario y lugar de los servicios (vacunación, exámen médico, cirurgías, cuidados estéticos)',
            findTheClosestPlaceToGetServices: 'Encontrar veterinarias, petshops más cercanos con disponibilidad de reserva',
            findWhereToPlayWithMyPet: 'Encontrar lugares para jugar con tu mascota',
            knowMoreAboutPets: 'Obtener más información sobre tus mascotas',
            ...
            beAbleToChatWithAVeterinarian: 'Poder mandar mensajes vía chat a tu veterinario en una emergencia sin costo extra',
            seeWhatPetsMyFriendsHave: 'Conocer más de las mascotas de mis amigos',
            findATrustedPersonToWalkMyPet: 'Encontrar una persona confiable para pasear tu mascota',
        },
    ...
    businessSurvey: {
        ...
        numberPlaces: '¿Cuántas sucursales tienen?',
        websiteSocialNetwork: 'Website / Red social',
        checkboxChoices: {
            acupuntura: 'Acupuntura',
            analgesiaTratamentoDolor: 'Analgésico/Tratamiento del dolor',
    ...
    entities: {
        ...
        petPhotos: {
            ...
            label: 'PetPhotos',
            menu: 'PetPhotos',
            exporterFileName: 'exportacion_petPhotos',
            list: {
                menu: 'PetPhotos',
                title: 'PetPhotos',
            },
            create: {
                success: 'PetPhotos guardado con éxito',
            },
            update: {
                success: 'PetPhotos guardado con éxito',
            },
            destroy: {
                success: 'PetPhotos eliminado con éxito',
            },
            destroyAll: {
                success: 'PetPhotos(s) eliminado con éxito',
            },
            edit: {
        ...
        petDiseases: {
            ...
            label: 'PetDiseases',
            menu: 'PetDiseases',
            exporterFileName: 'exportacion_petDiseases',
            list: {
                menu: 'PetDiseases',
                title: 'PetDiseases',
            },
            create: {
                success: 'PetDiseases guardado con éxito',
            },
            update: {
                success: 'PetDiseases guardado con éxito',
            },
            destroy: {
                success: 'PetDiseases eliminado con éxito',
            },
            destroyAll: {
                success: 'PetDiseases(s) eliminado con éxito',
            },
            edit: {
            ...
            new: {
                title: 'Nuevo PetDiseases',
            },
            view: {
                title: 'Ver PetDiseases',
            },
            importer: {
        ...
        businessServicesPrices: {
            ...
            exporterFileName: 'exportacion_businessServicesPrices',
            list: {
                menu: 'BusinessServicesPrices',
                title: 'BusinessServicesPrices',
            },
            create: {
                success: 'BusinessServicesPrices guardado con éxito',
            },
            update: {
                success: 'BusinessServicesPrices guardado con éxito',
            },
            destroy: {
                success: 'BusinessServicesPrices eliminado con éxito',
            },
            destroyAll: {
                success: 'BusinessServicesPrices(s) eliminado con éxito',
            },
            edit: {
            ...
            new: {
                title: 'Nuevo BusinessServicesPrices',
            },
            view: {
                title: 'Ver BusinessServicesPrices',
            },
            importer: {
        ...
        postCategories: {
            ...
            menu: 'PostCategories',
            exporterFileName: 'exportacion_postCategories',
            list: {
                menu: 'PostCategories',
