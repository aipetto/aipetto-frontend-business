const es = {
    common: {
        ...
        view: 'Ver',
        destroy: 'Eliminar',
        mustSelectARow: 'Elegí una opción',
        start: 'Comienzo',
        end: 'Final',
        select: 'Seleccioná',
        continue: 'Continuá',
    ...
    homeDownloadApp: {
        ...
        step4: {
            title: 'Disponibilidad horária',
            heading: "Reservá por dia y hora",
            description: "En general los servicios tardan 30 minutos a 1 hora",
    ...
    entities: {
        customer: {
            ...
            fields: {
                ...
                'uniqueCustomIdentifier': 'Identificador Único para el Cliente(IUC)',
                'source': 'Fuente',
                'userId': 'ID Usuario',
                'surname': 'Apellido',
                ...
                'address': 'Dirección',
                'addressStreetComplement': 'Complemento',
                'email': 'Email',
                ...
                'shippingAddressStreetComplement': 'Complemento de la dirección de entrega',
                ...
                'longitude': 'Longitude',
                'prospectStatus': 'Status del cliente potencial (prospecto)',
                'customerStatus': 'Status del cliente',
                'wantToReceiveNotifications': 'Quiere recibir notificaciones',
                'currency': 'Moneda',
                'balanceRange': 'Rango de Saldo',
                'balance': 'Saldo',
                'shippingAddressStreetNumber': 'Número de dirección principal',
                'addressStreetNumber': 'Número de dirección principal',
                'billingAddressStreetNumber': 'Número de dirección de facturación',
                'billingAddressStreetComplement': 'Complemento de dirección de facturación',
                'customerProfileImage': 'Imagem de Perfil',
                'facebook': 'Facebook',
                'linkedin': 'Linkedin',
                'instagram': 'Instagram',
                'website': 'Website',
            ...
            enumerators: {
                'source': {
                    'aipetto': 'Aipetto',
                    'phone_call': 'Via teléfono',
                    'whatsapp': 'Whatsapp',
                    'in_person': 'En Persona',
                    'website': 'Página web',
                    'recommended_by_friend': 'Recomendación de conocidos',
                    'email': 'Email',
                    'facebook': 'Facebook',
                    'twitter': 'Twitter',
                    'linkedin': 'Linkedin',
                ...
                'prospectStatus': {
                    'current_prospect': 'Prospecto Interesado',
                    'lost_prospect': 'Prospecto Rechazado',
                    'non_prospect': 'Sin contactar',
                },
                'customerStatus': {
                    'current_customer': 'Cliente Actual',
                    'past_customer': 'Cliente en el Pasado',
                    'non_customer': 'No es Cliente Aún',
                },
            },
            placeholders: {
                'balance': '0',
            ...
            hints: {
                'prospectStatus': 'Prospecto significa que no existe un contracto asociado.',
                'customerStatus': 'Hay un contrato, transacción o operación.',
            },
            new: {
                title: 'Nuevo Cliente',
            },
        ...
        product: {
            ...
            fields: {
                ...
                'language': 'Language',
                'country': 'País',
                'barcodeRange': 'Barcode',
                'barcode': 'Barcode',
                'productNCMRange': 'ProductNCM',
                'productNCM': 'ProductNCM',
                'inStockRange': 'InStock',
                'inStock': 'InStock',
                createdAt: 'Creado el',
                updatedAt: 'Actualizado el',
                createdAtRange: 'Creado el',
        ...
        pet: {
            ...
            fields: {
                ...
                'profileImage': 'Imagenes de perfil',
                'birthdateRange': 'Fecha de nacimiento',
                'birthdate': 'Cumpleaños',
                'ageRange': 'Edad',
                'age': 'Edad',
                ...
                'sex': 'Sexo',
                'breed': 'Raza',
                'secondBreedMixed': 'Mestizo Segunda Raza',
                'type': 'Tipo',
                'customerIds': 'IDs de los Clientes',
                'petOwners': 'Dueños de la Mascota',
                'photos': 'Fotos',
                'vaccines': 'Vacunas',
                'maturitySize': 'Tamaño',
                'furLength': 'Largo del Pelo',
                ...
                'numberOfLikesRange': 'Rango Número de Likes',
                'numberOfLikes': 'Número de Likes',
                'matches': 'Número de Posibles Cruzas',
                'petFriends': 'Mascotas Amigas',
                'governmentUniqueID': 'Identificador Único en Entidades Gubernamentales',
                'bloodType': 'Tipo Sanguineo',
                'hasMicrochip': '¿Contiene Microchip?',
                ...
                'longitudeRange': 'Longitude',
                'longitude': 'Longitude',
                'microchipNumberRange': 'MicrochipNumber',
                'microchipNumber': 'MicrochipNumber',
                'isDead': 'IsDead',
                'deathDateRange': 'DeathDate',
                'deathDate': 'DeathDate',
                'allowedBusinessesAccess': 'AllowedBusinessesAccess',
                'hasPedigree': 'HasPedigree',
                'isAggressive': 'IsAggressive',
                'isHyperActive': 'IsHyperActive',
                'allowedToGrooming': 'AllowedToGrooming',
                'phobias': 'Phobias',
                'feeding': 'Feeding',
                'isObsessive': 'IsObsessive',
                'isAntiSocial': 'IsAntiSocial',
                'generalNotes': 'GeneralNotes',
                'problemsAndRestrinctions': 'ProblemsAndRestrinctions',
                createdAt: 'Creado el',
                updatedAt: 'Actualizado el',
                createdAtRange: 'Creado el',
            },
        ...
        business: {
            ...
            importer: {
                ...
                fileName: 'plantilla_negocio_importar',
                hint:
                    'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
            },
        },
        ...
        place: {
            ...
            fields: {
                ...
                'starsRange': '¿Rango de votación de calidad?',
                'stars': 'Votación de calidad',
                'isOpen': 'Abierto',
                createdAt: 'Creado el',
                updatedAt: 'Actualizado el',
                createdAtRange: 'Creado el',
        ...
        serviceReservation: {
            ...
            fields: {
                ...
                'time': 'Hora',
                'needTransportation': 'Necesita Transporte',
                'place': 'Lugar',
                'status': 'Estado',
                ...
                'currency': 'Moneda',
                'digitalReservationDoc': 'Adjunto de la Reserva',
                'totalPriceTransportartionRange': 'Precio Total del Transporte',
                'totalPriceTransportartion': 'Precio Total del Transporte',
                'ratingFromCustomerRange': 'Rango de la Votación del Cliente',
            ...
            enumerators: {
                ...
                'status': {
                    'user_approval_pending': 'Esperando confirmación del Cliente',
                    'business_approval_pending': 'Esperando aprobación del Negocio',
                    'business_approved': 'Aprobado por Negocio',
                    'business_declined': 'Negado por Negocio',
                },
                'source': {
                    ...
                    'facebook_reservation': 'Reserva por Facebook Page',
                },
            },
            placeholders: {
        ...
        businessPlaceServiceAvailability: {
            ...
            menu: 'Disponibilidad',
            exporterFileName: 'disponibilidad_servicios_exportado',
            list: {
            ...
            fields: {
                ...
                'name': 'Nombre',
                'businessId': 'ID de Negocio',
                'timeSlot': 'Horario de Atención',
                'dateStartRange': 'Rango de Fecha Inicio',
                'dateStart': 'Fecha de Início',
                'dateEndRange': 'Rango de Fecha Límite',
                'dateEnd': 'Fecha Límite',
                'serviceType': 'Tipo de Servicio',
                'places': 'Sucursales',
                createdAt: 'Creado el',
                updatedAt: 'Actualizado el',
            ...
            placeholders: {
                'name': 'Nombre para la Disponibilidad de Reserva',
            },
            hints: {

            },
            new: {
                title: 'Nuevo Disponibilidad de Reserva',
            },
            view: {
                title: 'Ver Disponibilidad de Reserva',
            },
            importer: {
                title: 'Importar Horários Disponibles para Reserva',
                fileName: 'Importar Horários Disponibles para Reserva',
                hint:
                    'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
            },
        },
        ...
        providers: {
            ...
            fields: {
                ...
                'longitudeRange': 'Longitude',
                'longitude': 'Longitude',
                'basePricePerServiceRange': 'Rango Precios Base para Servicio',
                'basePricePerService': 'Precio Base para el Servicio',
                'currency': 'Moneda',
                'profileImage': 'Imagem de Perfil',
                'attachedDoc': 'Documento Adjuntos',
                'language': 'Lenguaje',
                'isIndependent': '¿Es monotributista?',
                createdAt: 'Creado el',
                updatedAt: 'Actualizado el',
                createdAtRange: 'Creado el',
            },
            ...
            importer: {
                ...
                fileName: 'proveedores_lista_importacion',
                hint:
                    'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
            },
        },
