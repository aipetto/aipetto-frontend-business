...
const selectPermissionToImport = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.businessPaymentCycleImport,
    ),
);
...
const selectPermissionToDestroy = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.businessPaymentCycleDestroy,
    ),
);

const businessPaymentCycleSelectors = {
...
export default businessPaymentCycleSelectors;
