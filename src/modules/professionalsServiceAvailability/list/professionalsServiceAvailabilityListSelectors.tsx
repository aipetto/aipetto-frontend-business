...
const selectRaw = (state) => state.professionalsServiceAvailability.list;
...
const professionalsServiceAvailabilityListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default professionalsServiceAvailabilityListSelectors;
