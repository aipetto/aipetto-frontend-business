...
const selectPermissionToEdit = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.professionalsServiceAvailabilityEdit,
    ),
);
...
const selectPermissionToImport = createSelector(
  ...
  (currentTenant, currentUser) =>
    new PermissionChecker(currentTenant, currentUser).match(
      Permissions.values.professionalsServiceAvailabilityImport,
    ),
);
...
const professionalsServiceAvailabilitySelectors = {
...
export default professionalsServiceAvailabilitySelectors;
