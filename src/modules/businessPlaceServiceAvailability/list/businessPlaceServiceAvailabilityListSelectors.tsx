...
const selectRaw = (state) => state.businessPlaceServiceAvailability.list;
...
const businessPlaceServiceAvailabilityListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default businessPlaceServiceAvailabilityListSelectors;
